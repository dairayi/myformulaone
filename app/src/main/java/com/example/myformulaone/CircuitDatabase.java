...
@Database(entities = {CircuitModal.class}, version = 1)
public abstract class CircuitDatabase extends RoomDatabase {
    //below line is to create instance for our database class.
    private static CircuitDatabase instance;

    //below line is to create abstract variable for dao.
    public abstract Dao3 Dao3();

    //on below line we are getting instance for our database.
    public static synchronized CircuitDatabase getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    Room.databaseBuilder(context.getApplicationContext(),
                                    CircuitDatabase.class, "circuit_database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        PopulateDbAsyncTask(CircuitDatabase instance) {
            Dao3 dao3 = instance.Dao3();
        }
