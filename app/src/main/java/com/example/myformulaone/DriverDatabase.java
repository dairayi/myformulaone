...
@Database(entities = {DriverModal.class}, version = 1)
public abstract class DriverDatabase extends RoomDatabase {
    ...
    public static synchronized DriverDatabase getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    Room.databaseBuilder(context.getApplicationContext(),
                                    DriverDatabase.class, "driver_database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        PopulateDbAsyncTask(DriverDatabase instance) {
